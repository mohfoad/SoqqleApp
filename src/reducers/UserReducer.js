...
import {createUserLogin, saveStories, saveWorld} from "../realm/RealmHelper";
...
export async function fetchProfileUser (data) {
  ...
  try {
    ...
    return fetchUserProfileFailed({ code: 500, message: 'Unexpected error!' })
  }
}
...
export async function saveShareContent (data) {
  try {
    ...
    return shareContentFailed({ code: 500, message: 'Unexpected error!' })
  }
}
...
export async function login (data) {
  try {
    ...
    try {
      ...
      createUserLogin(response.data.user);
    } catch (e) {
      bugsnag.notify(e);
      console.log(e);
    }
...
export async function getUserPosts (id) {
  try {
    ...
    return getUserPostsFailed({ code: 500, message: 'Unexpected error!' })
  }
}
...
export async function postsUserComments (data) {
  ...
  try {
    ...
    return postUserCommentsFailed({ code: 500, message: 'Unexpected error!' })
  }
}
/* user like */
/*  Post user comment  */
...
export async function apiForUserLike (data) {
  ...
  try {
    ...
    return userLikeFailed({ code: 500, message: 'Unexpected error!' })
  }
}
